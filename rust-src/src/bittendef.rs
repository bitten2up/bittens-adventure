...
pub type SaveData = ::std::os::raw::c_uint;
pub const BittenLayers_BACKGROUND_LAYER: BittenLayers = 1;
pub const BittenLayers_CHESTS_LAYER: BittenLayers = 3;
pub type BittenLayers = ::std::os::raw::c_uint;
pub type bit_sprite = _bit_sprite;
pub type bit_enemy = _bit_enemy;
pub type bit_player = _bit_player;
pub type bit_settings = _bit_settings;
pub type bit_game = _bit_game;
pub const bit_battleAni_intro: bit_battleAni = 0;
pub const bit_battleAni_waitInput: bit_battleAni = 1;
pub const bit_battleAni_playerAttack: bit_battleAni = 2;
pub const bit_battleAni_enemyAttack: bit_battleAni = 3;
pub const bit_battleAni_gameover: bit_battleAni = 4;
pub type bit_battleAni = ::std::os::raw::c_uint;
pub const bit_state_title: bit_state = 0;
pub const bit_state_overworld: bit_state = 1;
pub const bit_state_battle: bit_state = 2;
pub type bit_state = ::std::os::raw::c_uint;
pub const bit_direction_blank: bit_direction = 0;
pub const bit_direction_down: bit_direction = 1;
pub const bit_direction_left: bit_direction = 2;
pub const bit_direction_right: bit_direction = 3;
pub const bit_direction_up: bit_direction = 4;
pub type bit_direction = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _bit_sprite {
    pub img: Texture2D,
    pub rec: Rectangle,
    pub pos: Vector2,
    pub direction: bit_direction,
}
#[test]
fn bindgen_test_layout__bit_sprite() {
    const UNINIT: ::std::mem::MaybeUninit<_bit_sprite> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_bit_sprite>(),
        48usize,
        concat!("Size of: ", stringify!(_bit_sprite))
    );
    assert_eq!(
        ::std::mem::align_of::<_bit_sprite>(),
        4usize,
        concat!("Alignment of ", stringify!(_bit_sprite))
    );
    assert_eq!(
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _bit_enemy {
    pub sprite: bit_sprite,
    pub name: [::std::os::raw::c_char; 20usize],
    pub health: f32,
}
#[test]
fn bindgen_test_layout__bit_enemy() {
    const UNINIT: ::std::mem::MaybeUninit<_bit_enemy> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_bit_enemy>(),
        72usize,
        concat!("Size of: ", stringify!(_bit_enemy))
    );
    assert_eq!(
        ::std::mem::align_of::<_bit_enemy>(),
        4usize,
        concat!("Alignment of ", stringify!(_bit_enemy))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sprite) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_bit_enemy),
            "::",
            stringify!(sprite)
        )
    );
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _bit_player {
    pub sprite: bit_sprite,
    pub name: [::std::os::raw::c_char; 20usize],
    pub pronouns: [::std::os::raw::c_char; 10usize],
    pub health: f32,
    pub x: i16,
    pub y: i16,
}
#[test]
fn bindgen_test_layout__bit_player() {
    const UNINIT: ::std::mem::MaybeUninit<_bit_player> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_bit_player>(),
        88usize,
        concat!("Size of: ", stringify!(_bit_player))
    );
    assert_eq!(
        ::std::mem::align_of::<_bit_player>(),
        4usize,
        concat!("Alignment of ", stringify!(_bit_player))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sprite) as usize - ptr as usize },
        0usize,
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).pronouns) as usize - ptr as usize },
        68usize,
        concat!(
            "Offset of field: ",
            stringify!(_bit_player),
...
#[test]
fn bindgen_test_layout__bit_settings() {
    const UNINIT: ::std::mem::MaybeUninit<_bit_settings> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_bit_settings>(),
        12usize,
        concat!("Size of: ", stringify!(_bit_settings))
    );
    assert_eq!(
        ::std::mem::align_of::<_bit_settings>(),
        4usize,
        concat!("Alignment of ", stringify!(_bit_settings))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).width) as usize - ptr as usize },
        0usize,
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).modded) as usize - ptr as usize },
        9usize,
        concat!(
            "Offset of field: ",
            stringify!(_bit_settings),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).silent) as usize - ptr as usize },
        10usize,
        concat!(
            "Offset of field: ",
            stringify!(_bit_settings),
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _bit_game {
    pub settings: bit_settings,
    pub player: bit_player,
    pub enemy: bit_enemy,
    pub state: bit_state,
...
fn bindgen_test_layout__bit_game() {
    const UNINIT: ::std::mem::MaybeUninit<_bit_game> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).battleAni) as usize - ptr as usize },
        176usize,
        concat!(
            "Offset of field: ",
            stringify!(_bit_game),
